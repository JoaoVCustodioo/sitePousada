...
const FeedbackText = () => {
  return (
    <div className="min-h-[24rem] flex flex-col md:flex-row gap-8 md:gap-56 items-start justify-center mt-10 md:mt-20">
      <div className="p-4 md:p-6 w-full max-w-md text-center">
        <h2 className="text-2xl md:text-4xl font-bold text-brown-800 mb-4">Rodrigo Capitano</h2>
        <p className="text-brown-600 text-base md:text-lg mb-4">
        ...
        <div className="flex justify-center">
          {[...Array(5)].map((_, index) => (
            <span key={index} className="text-yellow-500 text-3xl md:text-6xl">★</span>
          ))}
        </div>
      </div>

      <div className="p-4 md:p-6 w-full max-w-md text-center">
        <h2 className="text-2xl md:text-4xl font-bold text-brown-800 mb-4">Bernardo Kowalsky</h2>
        <p className="text-brown-600 text-base md:text-lg mb-4">
